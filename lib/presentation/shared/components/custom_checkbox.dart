...
// const double _kStrokeWidth = _kEdgeSize * 0.125;
...
class _CheckboxPainter extends ToggleablePainter {
  ...
  double get _strokeWidth => width * 0.125;
  ...
  Rect _outerRectAt(Offset origin, double t) {
    ...
    final double size = width - inset * _strokeWidth;
    final Rect rect =
  ...
  void _drawCheck(Canvas canvas, Offset origin, double t, Paint paint) {
    ...
    final Offset start = Offset(width * 0.287, width * 0.5);
    final Offset mid = Offset(width * 0.412, width * 0.6);
    final Offset end = Offset(width * 0.712, width * 0.375);
    if (t < 0.5) {
